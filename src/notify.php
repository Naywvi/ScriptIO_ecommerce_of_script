...
function toast(...$popup){
    ...
    <html>
   <body>
      <div id="notification" class="toast__container">
         <div class="toast__cell">
         <script>setTimeout(() => {
            const element1 = document.getElementById("popup1");
            element1.remove();
            const element2 = document.getElementById("popup2");
            element2.remove();
            const element3 = document.getElementById("popup3");
            element3.remove();
          }, 5000);</script>
            ';
            foreach($popup as $v){
...
function green($content,$title){
    $content ='
        <div id="popup1" class="toast toast--green add-margin">
...
function blue($content,$title){
    $content = '
        <div id="popup2" class="toast toast--blue add-margin">
            <div class="toast__icon">
...
function yellow($content,$title){
    $content = '
        <div id="popup3" class="toast toast--yellow add-margin">
            <div class="toast__icon">
