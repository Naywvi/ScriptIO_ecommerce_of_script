...
function connexion($user){
    if(strlen($user['id_user']) == 0){
        ...
        echo'
        <li class="nav-item" >
            <a class="nav-link nav-color disabled" href="signin" tabindex="-1" aria-disabled="true" style="cursor: pointer !important;pointer-events: all;">Sign in</a>
        </li>

        <li class="nav-item" >
            <a class="nav-link nav-color disabled" href="signup" tabindex="-1" aria-disabled="true" style="cursor: pointer !important;pointer-events: all;">Sign Up</a>
        </li> 
        ';
        ...
        <li class="nav-item" >
            <a class="nav-link nav-color disabled" href="?signout" onclick="signout()" tabindex="-1" aria-disabled="true" style="cursor: pointer !important;pointer-events: all;">Sign Out</a>
        </li> 
